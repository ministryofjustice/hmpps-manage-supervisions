 ...
 * 
 * @export
 * @interface ContextlessAppointmentRescheduleRequest
 */
export interface ContextlessAppointmentRescheduleRequest {
    /**
     * 
     * @type {boolean}
     * @memberof ContextlessAppointmentRescheduleRequest
     */
