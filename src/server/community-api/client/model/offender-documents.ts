...
import { ConvictionDocuments } from './conviction-documents';
import { OffenderDocumentDetail } from './offender-document-detail';

/**
 * 
 * @export
 * @interface OffenderDocuments
 */
export interface OffenderDocuments {
    /**
     * 
     * @type {Array<ConvictionDocuments>}
     * @memberof OffenderDocuments
     */
    convictions?: Array<ConvictionDocuments>;
    /**
     * 
     * @type {Array<OffenderDocumentDetail>}
     * @memberof OffenderDocuments
     */
    documents?: Array<OffenderDocumentDetail>;
}
