...
import { CourtAppearanceMinimal } from './court-appearance-minimal';

/**
 * Court appearance list Wrapper
 * @export
 * @interface CourtAppearanceMinimalWrapper
 */
export interface CourtAppearanceMinimalWrapper {
    /**
     * List of court appearances
     * @type {Array<CourtAppearanceMinimal>}
     * @memberof CourtAppearanceMinimalWrapper
     */
    courtAppearances?: Array<CourtAppearanceMinimal>;
}
