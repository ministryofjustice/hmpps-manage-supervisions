...
import { ReportDocumentDates } from './report-document-dates';

/**
 * 
 * @export
 * @interface OffenderDocumentDetail
 */
export interface OffenderDocumentDetail {
    /**
     * 
     * @type {string}
     * @memberof OffenderDocumentDetail
     */
    author?: string;
    /**
     * 
