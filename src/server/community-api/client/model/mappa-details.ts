 ...
 * MAPPA Details
 * @export
 * @interface MappaDetails
 */
export interface MappaDetails {
    /**
     * MAPPA Category (0 = unknown)
     * @type {number}
     * @memberof MappaDetails
     */
    category?: MappaDetailsCategory;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum MappaDetailsCategory {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3
