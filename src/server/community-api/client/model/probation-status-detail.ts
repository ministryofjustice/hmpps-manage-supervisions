 ...
 * 
 * @export
 * @interface ProbationStatusDetail
 */
export interface ProbationStatusDetail {
    /**
     * True if the offender is in breach of a current sentence
     * @type {boolean}
     * @memberof ProbationStatusDetail
     */
    inBreach?: boolean;
    /**
     ...
     * @memberof ProbationStatusDetail
     */
    status?: ProbationStatusDetailStatus;
}
...
/**
    ...
    * @enum {string}
    */
export enum ProbationStatusDetailStatus {
    Current = 'CURRENT',
    NotSentenced = 'NOT_SENTENCED',
    PreviouslyKnown = 'PREVIOUSLY_KNOWN'
}
