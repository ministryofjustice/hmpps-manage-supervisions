...
import { OffenderRecall } from './offender-recall';
import { OffenderRelease } from './offender-release';

/**
 * 
 * @export
 * @interface OffenderLatestRecall
 */
export interface OffenderLatestRecall {
    /**
     * 
     * @type {OffenderRecall}
     * @memberof OffenderLatestRecall
     */
    lastRecall?: OffenderRecall;
    /**
     * 
     * @type {OffenderRelease}
     * @memberof OffenderLatestRecall
     */
