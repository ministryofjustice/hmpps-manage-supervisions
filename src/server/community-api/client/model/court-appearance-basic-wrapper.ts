...
import { CourtAppearanceBasic } from './court-appearance-basic';

/**
 * Court appearance list Wrapper
 * @export
 * @interface CourtAppearanceBasicWrapper
 */
export interface CourtAppearanceBasicWrapper {
    /**
     * List of court appearances
     * @type {Array<CourtAppearanceBasic>}
     * @memberof CourtAppearanceBasicWrapper
     */
    courtAppearances?: Array<CourtAppearanceBasic>;
}
