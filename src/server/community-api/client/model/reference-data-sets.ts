...
export interface ReferenceDataSets {
    /**
     * List of reference data sets, for example  {             \"code\": \"ADDITIONAL SENTENCE\",             \"description\": \"Additional Sentence\"         }
     * @type {Array<KeyValue>}
     * @memberof ReferenceDataSets
     */
    referenceDataSets?: Array<KeyValue>;
}
