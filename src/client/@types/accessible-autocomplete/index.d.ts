interface AccessibleAutoCompleteOptionsBase {
  ...
  templates?: {
     ...
     * Caution: because this function allows you to output arbitrary HTML, you should make sure it's trusted, and accessible.
     */
...
declare function accessibleAutocomplete(options: AccessibleAutocompleteOptions): void
...
declare namespace accessibleAutocomplete {
   ...
   */
  function enhanceSelectElement(options: EnhanceSelectElementOptions): void
}
